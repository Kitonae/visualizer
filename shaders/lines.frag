/* Animated lines shader - converted from Shadertoy to LÖVE2D
...
vec4 effect(vec4 color, Image texture, vec2 texture_coords, vec2 screen_coords)
{
    ...
    vec2 space = (screen_coords - resolution.xy / 2.0) / resolution.x * 2.0 * scale;
    ...
    // Background colors
    vec4 bgColor1 = lineColor * 0.5;
    vec4 bgColor2 = lineColor - vec4(0.2, 0.2, 0.7, 1.0);
