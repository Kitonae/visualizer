/* Monochrome lines shader - converted from Shadertoy to LÖVE2D
 */
...
#define COUNT 20.
#define COL_BLACK vec3(0.0, 0.0, 0.0) 
...
{
    // Rotate camera 180 degrees by flipping UV coordinates
    vec2 uv = (resolution - screen_coords)/resolution.y;
